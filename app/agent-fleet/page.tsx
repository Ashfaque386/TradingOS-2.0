...
import { AlertTriangle, Bot, LockKeyhole, Pause, Plus, RotateCcw, Search, ShieldCheck, SlidersHorizontal, X, Zap } from 'lucide-react'
import { ShellLayout } from '@/components/shell/shell-layout'
import { useAuth } from '@/components/auth/auth-provider'
import { type AgentSummary, ApiError, getAgents, getGatewayConfig, putGatewayConfig } from '@/lib/api'
...
const tabs = ['Identity', 'Skills', 'Heartbeat', 'Enable / Disable']
