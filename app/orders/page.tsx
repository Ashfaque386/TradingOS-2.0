...
export default function OrdersPage() {
  ...
  return <ShellLayout><main className="orders-page mx-auto w-full max-w-[1700px] pb-10">
    ...
    <section className="orders-summary">
      ...
      <div className="summary-stat"><span>CAPPED THIS SESSION</span><strong>{intents.filter(i => i.status === 'capped').length}</strong><small>live order intents blocked by the standing rate/notional cap</small></div>
